    ...
    <div className="page-container fade-in">
        ...
        {filtered.map((cls) => (
          <Link key={cls.id} href={`/classes/${cls.id}`} style={{ textDecoration: 'none' }}>
            ...
            >
              ...
              <div style={{
                height: '100px',
                background: `linear-gradient(135deg, ${cls.color}ee, ${cls.color}99)`,
                position: 'relative',
                overflow: 'hidden',
                display: 'flex',
                alignItems: 'center',
                ...
                {cls.createdBy?.name && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '14px' }}>
                    <div style={{
                      ...
                      fontSize: '10px', fontWeight: '700', color: cls.color,
                    }}>
                      {cls.createdBy.name.charAt(0).toUpperCase()}
                    </div>
      ...
      {filtered.length === 0 && (
        <div className="empty-state">
          ...
          <p style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>No classes found</p>
