          ...
          <div className="card" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '16px' }}>
              <div style={{ background: 'var(--surface-2)', padding: '16px', borderRadius: '12px', border: '1px solid var(--border-light)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '12px' }}>
                <div>
                  <div style={{ fontSize: '13px', fontWeight: '700', color: 'var(--text-primary)' }}>1. Auto-distribute All Users to Default Pool</div>
                  <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '4px', margin: 0 }}>
                    Automatically processes every user in your database and assigns them to the default Pool Group ("General Announcements").
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div style={{ background: 'var(--surface-2)', padding: '16px', borderRadius: '12px', border: '1px solid var(--border-light)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '12px' }}>
                <div>
                  <div style={{ fontSize: '13px', fontWeight: '700', color: 'var(--text-primary)' }}>2. Assign Specific Pool Group to Everyone</div>
                  <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '4px', marginBottom: '8px' }}>
                    Assigns a specific Pool Group to **ALL** users in the database (preserving their current group list).
                  </p>
                  ...
                  <select
                    ...
                    disabled={isBulkRunning || categories.length === 0}
                  >
                    <option value="">-- Select a Pool Group --</option>
                ...
                >
                  {isBulkRunning ? 'Processing...' : '✉️ Assign Pool Group to Everyone'}
                </button>
              </div>
            </div>
          </div>
