              ...
              return (
                ...
                >
                  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', minWidth: '56px' }}>
                    <span style={{ fontSize: '13px', fontWeight: 800, color: 'var(--text-primary)' }}>{ev.time || '—'}</span>
                    {ev.endTime && (
                      <span style={{ fontSize: '10px', color: 'var(--text-muted)', fontWeight: 600 }}>to {ev.endTime}</span>
                    )}
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              {selectedEvent.meetLink && (
                <div>
                  ...
                  <a href={selectedEvent.meetLink} target="_blank" rel="noreferrer" style={{ fontSize: '13px', color: 'var(--info)', wordBreak: 'break-all' }}>
                    {selectedEvent.meetLink}
                  </a>
                </div>
              )}
