                    ...
                    >
                      ...
                      {user.isGoogleAuth && (
                        <span style={{
                          ...
                          fontSize: '10px', fontWeight: '600', color: '#4285F4',
                          background: '#e8f0fe', padding: '1px 8px', borderRadius: '20px',
                        }}>
