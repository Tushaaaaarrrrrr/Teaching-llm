      ...
      case DocType.privacyPolicy:
        return const Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            _Paragraph(
              'This Privacy Notice for GENZ IITIAN ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you visit our website (https://class.genziitian.in/), use our mobile app (GENZ IITIAN), or engage with our courses and community.',
            ),
            SizedBox(height: 8),
            _Paragraph(
              'If you have questions or concerns, please contact us at ADMIN@GENZIITIAN.ORG or GENZIITIAN@GMAIL.COM.',
            ),
            SizedBox(height: 20),
            _SectionHeader(num: '01', title: 'What Information Do We Collect?'),
            SizedBox(height: 8),
            _Paragraph(
              'We collect personal information that you voluntarily provide to us when you register, participate in activities, or contact us (name, email, phone, authentication data). Payment details are securely processed by Razorpay and are never stored on our servers. We process payments on our website only.',
            ),
            SizedBox(height: 20),
            _SectionHeader(num: '02', title: 'How Do We Process Your Information?'),
            SizedBox(height: 8),
            _Bullet('Facilitate user accounts, login authentication, and profile management'),
            _Bullet('Deliver courses, live sessions, and study materials'),
            _Bullet('Enable student peer communication in community chat'),
            _Bullet('Provide support, fraud prevention, and security monitoring'),
            _Bullet('Comply with applicable legal obligations'),
            SizedBox(height: 20),
            _SectionHeader(num: '03', title: 'Sharing Your Personal Information'),
            SizedBox(height: 8),
            _Paragraph(
              'We do not sell personal data. We share information only with essential service providers: Supabase (database & storage), Google Sign-In (authentication), Razorpay (payment processing), and PostHog (telemetry).',
            ),
            SizedBox(height: 20),
            _SectionHeader(num: '04', title: 'Data Retention & Safety'),
            SizedBox(height: 8),
            _Paragraph(
              'We retain information as long as you maintain an active account. We implement technical and organizational security measures including encryption and role-based access control to protect your data.',
            ),
            SizedBox(height: 20),
            _SectionHeader(num: '05', title: 'Your Privacy Rights & Account Deletion'),
            SizedBox(height: 8),
            _Paragraph(
              'You can review, update, or request permanent deletion of your account anytime via Settings > Danger Zone ("Delete Your Account") or by contacting our built-in support.',
            ),
            SizedBox(height: 20),
            _SectionHeader(num: '06', title: 'Service Description & Intellectual Property'),
            SizedBox(height: 8),
            _Paragraph(
              'Gen-Z IITian provides digital educational courses delivered entirely online. All content (videos, documents, codes) is the intellectual property of Gen-Z IITian. Unauthorized distribution or piracy will result in immediate termination of access and legal action.',
            ),
            SizedBox(height: 20),
            _SectionHeader(num: '07', title: 'Return & Refund Policy'),
            SizedBox(height: 8),
            _Paragraph(
              'Due to the digital nature of our courses, all purchases are final. We do not offer refunds, returns, or exchanges once a course has been purchased.',
            ),
            SizedBox(height: 20),
            _SectionHeader(num: '08', title: 'Contact Us'),
            SizedBox(height: 8),
            _Paragraph(
              'Email: ADMIN@GENZIITIAN.ORG , GENZIITIAN@GMAIL.COM\nAddress: GENZ IITIAN, Patna, Bihar 800001, India',
            ),
          ],
        );
